...
class ChangeAssignmentRequest(object):
    ...
    def characteristic_types(self):
        ...
        List of references to characteristic types corresponding to the assignment  # noqa: E501
    ...
    def scope_id(self):
        ...
        The ID of the scope the assignment corresponds to. The scopeId will be removed in the next major release.  # noqa: E501
