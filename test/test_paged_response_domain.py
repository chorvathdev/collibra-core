...
from collibra_core.models.paged_response_domain import PagedResponseDomain  # noqa: E501
...
class TestPagedResponseDomain(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = collibra_core.models.paged_response_domain.PagedResponseDomain()  # noqa: E501
        if include_optional :
            return PagedResponseDomain(
                total = 1000, 
                offset = 10, 
                limit = 100, 
                results = [
